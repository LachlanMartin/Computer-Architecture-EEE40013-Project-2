...
static int64_t star_value=0;              /* value '*' has in expressions */
...
static int expression(const char *&ptr, int64_t &value);
...
*/
void set_star_value(int64_t address) {
...
*/
int64_t parse_num(const char *&arg) {
   int64_t value = 0;
...
*/
static int unsigned_number(const char *&ptr, int64_t &value) {
...
/*
  Parses a signed number
    ...
    number ::= '-' number |
          unsigned_number
*/
static int number(const char *&ptr, int64_t &value) {
...
*/
static int term(const char *&ptr, int64_t &value) {
...
/*
  ...
  Returns :
    ...
    == 1  => success : value = expression value
		       *ptr is advanced past expression
*/
int exprn(const char *&ptr, int64_t &value) {

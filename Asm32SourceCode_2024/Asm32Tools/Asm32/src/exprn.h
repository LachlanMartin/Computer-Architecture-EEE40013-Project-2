...
*/
extern int64_t parse_num(char const *&arg);
...
*/
extern void set_star_value(int64_t address);
 ...
 The following only occurs if LABELS is #defined
            ...
            == 1  => success
                        *ptr  = advanced to end of expression
                        value = expression value
*/
extern int exprn(char const *&ptr, int64_t &value);
/*
...
*/
int optexprn(const char *&ptr, int64_t &value);
